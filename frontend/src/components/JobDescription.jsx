  ...
  return (
    <div className="max-w-7xl mx-auto my-10">
        ...
        <Button
          ...
          className={`rounded-lg ${
            isApplied
              ...
              : "bg-[#7209b7] hover:bg-[#5f32ad] cursor-pointer active:scale-95"
          }`}
        >
      ...
      <div className="my-4">
        ...
        <h1 className="font-bold my-1">
          {" "}
          Location:<span className="pl-4 font-normal text-gray-800">Delhi</span>
        </h1>
        <h1 className="font-bold my-1">
          {" "}
          Description:
        ...
        <h1 className="font-bold my-1">
          {" "}
          Posted Date:
          <span className="pl-4 font-normal text-gray-800">18-12-2025</span>
        </h1>
      </div>
    </div>
  );
